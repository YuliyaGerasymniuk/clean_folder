...
def normalize(file):
    maps = {"а": "a", "б": "b", "в": "v", "г": "g", "д": "d", "е": "e", "ё": "e", "ж": "zh", "з": "z", "и": "i",
            "й": "y", "к": "k", "л": "l", "м": "m", "н": "n", "о": "o", "п": "p", "р": "r", "с": "s", "т": "t",
            "у": "u", "ф": "f", "х": "h", "ц": "ts", "ч": "ch", "ш": "sh", "щ": "sch", "ъ": "", "ы": "y", "ь": "",
            "э": "e", "ю": "yu", "я": "ya", "і": "i", "є": "e", "ї": "i", "А": "A", "Б": "B", "В": "V", "Г": "G",
            "Д": "D", "Е": "E", "Ё": "E", "Ж": "h", "З": "Z", "И": "I", "Й": "Y", "К": "K", "Л": "L", "М": "M",
    ...
    for elem in name_file:
        if elem in maps:
            new_name += maps[elem]
        elif (ord("A") <= ord(elem) <= ord("Z")) or \
                (ord("a") <= ord(elem) <= ord("z")) or elem.isdigit():
            new_name += elem
        else:
            new_name += "_"
        ...
        if file_ending in video_folder:
            ...
            try:
                shutil.unpack_archive(shutil.move(file_path, new_path),
                                      os.path.join(archives_path,
                                      normalize(file).rstrip(file_ending)))
            except shutil.ReadError:
                print(f"архів {normalize(file)} не може розпакуватись.")
            finally:
